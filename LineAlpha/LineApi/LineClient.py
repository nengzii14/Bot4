...
class LineClient(LineApi):
    ...
    def _loginresult(self):
        if self.isLogin == True:
            print "Vodkamod-Bot\n"
            print "-------------------------------------------------\nCredit :\nBot ini berdasarkan dari script LineVodka milik merkremont dan di modding oleh Bamzky, Oleh sebab itu jika mau mengedit botnya harap izin dulu ke id line : bamaseptituta\n\nTerima Kasih,\nBamzky\n-------------------------------------------------\n"
